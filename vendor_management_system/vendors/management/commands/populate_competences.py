...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write(
            self.style.NOTICE("Inizio popolamento competenze...")
        )
        ...
        competences_data = [
            ...
            },
            {
                ...
                "description": (
                    "Tecnico per la prevenzione incendi ai sensi del DM 818"
                ),
                "competence_category": "SAFETY",
                "requires_certification": True,
                "requires_renewal": True,
            ...
            },
            {
                ...
                "description": (
                    "Professionista abilitato alla progettazione antincendio"
                ),
                "competence_category": "SAFETY",
                "requires_certification": True,
                "requires_renewal": True,
            ...
            },
            {
                ...
                "name": "QRA/FERA",
                "description": (
                    "Quantitative Risk Assessment / Fire and "
            ...
            },
            {
                ...
                "description": (
                    "Requisiti per formatore in materia di salute "
            ...
            },
            {
                ...
                "description": (
                    "Esperto in Gestione dell'Energia certificato "
                    "UNI CEI 11339"
                ),
                "competence_category": "ENERGY",
                "requires_certification": True,
            ...
            # Audit e Certificazioni
            {
                ...
                "name": "AUDITOR 14001",
                "description": (
                    "Auditor per sistemi di gestione ambientale ISO 14001"
                ),
            ...
            },
            {
                ...
                "name": "AUDITOR 45001",
                "description": (
                    "Auditor per sistemi di gestione salute e "
                    "sicurezza ISO 45001"
                ),
                "competence_category": "AUDIT",
                "requires_certification": True,
            ...
            },
            {
                ...
                "name": "AUDITOR 9001",
                "description": (
                    "Auditor per sistemi di gestione qualità ISO 9001"
                ),
                "competence_category": "AUDIT",
                "requires_certification": True,
                "requires_renewal": True,
            ...
            },
            {
                ...
                "name": "AUDITOR 50001",
                "description": (
                    "Auditor per sistemi di gestione energia ISO 50001"
                ),
                "competence_category": "AUDIT",
                "requires_certification": True,
                "requires_renewal": True,
            ...
            },
            {
                ...
                "description": (
                    "Auditor per sistemi di gestione sicurezza e "
        ...
        for data in competences_data:
            ...
            if created:
                ...
                self.stdout.write(
                    self.style.SUCCESS(
                        f"✓ Creata competenza: {competence.code} - "
                        f"{competence.name}"
                    )
                )
            else:
                ...
                self.stdout.write(
                    self.style.WARNING(
                        f"↻ Aggiornata competenza: {competence.code} "
                        f"- {competence.name}"
                    )
                )
