"""
Management command per popolare i tipi di documenti comuni richiesti
ai fornitori.
    ...
    def handle(self, *args, **options):
        ...
        document_types_data = [
            # Documenti Legali/Amministrativi
            {
                ...
                "description": (
                    "Documento che attesta la regolarità "
            ...
            },
            {
                ...
                "description": (
                    "Certificazione antimafia rilasciata dalla Prefettura"
                ),
                "document_category": "LEGAL",
                "is_mandatory": True,
                "requires_renewal": True,
            ...
            # Documenti Assicurativi
            {
                ...
                "description": (
                    "Polizza assicurativa responsabilità civile professionale"
                ),
            ...
            },
            {
                ...
                "description": (
                    "Polizza assicurativa responsabilità civile operativa"
                ),
                "document_category": "INSURANCE",
                "is_mandatory": True,
                "requires_renewal": True,
            ...
            # Documenti di Sicurezza
            {
                ...
                "description": (
                    "Documento di valutazione dei rischi secondo D.Lgs 81/2008"
                ),
            ...
            },
            {
                ...
                "description": (
                    "Attestati di formazione dei lavoratori sulla sicurezza"
                ),
                "document_category": "SAFETY",
                "is_mandatory": True,
                "requires_renewal": True,
            ...
            # Certificazioni di Qualità
            {
                ...
                "description": (
                    "Certificazione sistema gestione qualità ISO 9001"
                ),
            ...
            },
            {
                ...
                "description": (
                    "Certificazione sistema gestione ambientale ISO 14001"
                ),
                "document_category": "CERTIFICATION",
                "is_mandatory": False,
                "requires_renewal": True,
            ...
            },
            {
                ...
                "description": (
                    "Certificazione sistema gestione salute e "
                    "sicurezza ISO 45001"
                ),
                "document_category": "CERTIFICATION",
                "is_mandatory": False,
            ...
            },
            {
                ...
                "description": (
                    "Certificazione sistema gestione energia ISO 50001"
                ),
                "document_category": "CERTIFICATION",
                "is_mandatory": False,
                "requires_renewal": True,
