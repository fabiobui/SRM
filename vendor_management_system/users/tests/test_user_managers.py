...
class TestUserManager:
    ...
    # Method to test the create_user method with is_staff or is_superuser
    # set to True
    ...
    # Method to test the create_superuser method with is_staff or
    # is_superuser set to False
    def test__create_superuser_with_is_staff_or_is_superuser_set_to_false(
        self,
    ):
