...
def dashboard_redirect(request):
    ...
    if user.is_superuser or user.is_staff:
        ...
        messages.warning(
            request,
            "Il tuo account non ha un ruolo assegnato. "
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Il tuo account <strong>{user.email}</strong>
                                non ha un ruolo configurato.</p>
                                <p>Contatta l'amministratore del sistema
                                per assegnare un ruolo.</p>
                                <div class="mt-3">
                                    <a href="{logout_url}"
                                    class="btn btn-secondary">Logout</a>
                                    <a href="{admin_url}"
                                    class="btn btn-primary">Pannello Admin</a>
                                </div>
                            </div>
                        </div>
                    </div>
