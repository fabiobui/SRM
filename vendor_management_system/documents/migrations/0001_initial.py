        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    ...
                    models.CharField(
                        editable=False,
                        help_text="Unique ID for Document Type",
                        max_length=10,
                        primary_key=True,
                        serialize=False,
                        unique=True,
                        verbose_name="Document Type ID",
                    ),
                ),
                (
                    "name",
                    models.CharField(
                        help_text=(
                            "Name of document type (e.g. DURC, ISO 9001, etc.)"
                        ),
                        max_length=100,
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text=(
                            "Whether this document is required for vendor "
                            "qualification"
                        ),
                ...
                (
                    ...
                    models.IntegerField(
                        default=365,
                        help_text="How many days this document is valid for",
                ...
                (
                    ...
                    models.IntegerField(
                        default=30,
                        help_text="Send reminder X days before expiry",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="PENDING",
                        help_text="Current status of document",
                        max_length=20,
                        verbose_name="Status",
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="When document was reviewed",
                        null=True,
                ...
                (
                    "vendor",
                    models.ForeignKey(
                        help_text="Vendor who owns this document",
